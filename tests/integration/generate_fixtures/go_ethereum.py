...
def generate_go_happyuc_fixture(destination_dir):
    with contextlib.ExitStack() as stack:
        ...
        ghuc_proc = stack.enter_context(common.get_ghuc_process(  # noqa: F841
...
def setup_chain_state(webu):
    ...
    math_deploy_receipt = common.deploy_contract(webu, 'math', math_contract_factory)
    ...
    emitter_deploy_receipt = common.deploy_contract(webu, 'emitter', emitter_contract_factory)
    ...
    txn_receipt_with_log = common.mine_transaction_hash(webu, txn_hash_with_log)
    ...
    # Empty Block
    #
    empty_block_number = common.mine_block(webu)
    ...
    #
    webu.personal.unlockAccount(coinbase, common.KEYFILE_PW)
    webu.miner.start(1)
    ...
    mined_txn_receipt = common.mine_transaction_hash(webu, mined_txn_hash)
