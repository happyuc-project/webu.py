...
def test_contract_abi_encoding(webu, abi, method, arguments, data, expected):
    contract = webu.eth.contract(abi=abi)
...
def test_contract_abi_encoding_kwargs(webu, abi, method, kwargs, expected):
    contract = webu.eth.contract(abi=abi)
