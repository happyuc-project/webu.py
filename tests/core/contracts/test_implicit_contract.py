...
@pytest.fixture()
def math_contract(webu, MATH_ABI, MATH_CODE, MATH_RUNTIME):
    ...
    tx_receipt = webu.eth.getTransactionReceipt(tx_hash)
...
@pytest.fixture()
def get_transaction_count(webu):
    def get_transaction_count(blocknum_or_label):
        block = webu.eth.getBlock(blocknum_or_label)
...
def test_implicitcontract_transact_default(webu, math_contract, get_transaction_count):
