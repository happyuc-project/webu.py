...
def test_to_int(val, expected):
    if isinstance(expected, type):
        ...
        assert Webu.toInt(val) == expected
...
def test_to_int_text(val, expected):
    if isinstance(expected, type):
        ...
        assert Webu.toInt(text=val) == expected
...
def test_to_int_hexstr(val, expected):
    assert Webu.toInt(hexstr=val) == expected
...
def test_to_hex(val, expected):
    assert Webu.toHex(val) == expected
...
def test_to_hex_text(val, expected):
    assert Webu.toHex(text=val) == expected
...
def test_to_hex_cleanup_only(val, expected):
    assert Webu.toHex(hexstr=val) == expected
