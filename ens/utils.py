...
def customize_webu(w3):
    from webu.contract import ConciseContract
    from webu.middleware import make_stalecheck_middleware
...
def normalize_name(name):
    ...
    <https://github.com/happyuc-project/EIPs/blob/master/EIPS/eip-137.md#name-syntax>`_
