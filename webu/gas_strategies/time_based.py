...
def construct_time_based_gas_price_strategy(max_wait_seconds,
    ...
    :param probability: An integer representation of the desired probability
        ...
        and 100 means 100%.
    """
    def time_based_gas_price_strategy(webu, transaction_params):
        avg_block_time = _get_avg_block_time(webu, sample_size=sample_size)
        wait_blocks = int(math.ceil(max_wait_seconds / avg_block_time))

        raw_miner_data = _get_raw_miner_data(webu, sample_size=sample_size)
