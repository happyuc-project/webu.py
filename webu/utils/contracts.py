...
def encode_abi(webu, abi, arguments, data=None):
...
def encode_transaction_data(abi, webu, fn_identifier, args=None, kwargs=None):
    if fn_identifier is FallbackFn:
    ...
    return add_0x_prefix(encode_abi(webu, fn_abi, fn_arguments, fn_selector))
