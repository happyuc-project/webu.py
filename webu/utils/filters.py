...
from webu.utils.validation import (
    validate_address,
)
...
class Filter:
    ...
    def __init__(self, webu, filter_id):
        self.webu = webu
    ...
    def get_new_entries(self):
        log_entries = self._filter_valid_entries(self.webu.eth.getFilterChanges(self.filter_id))
        return self._format_log_entries(log_entries)

    def get_all_entries(self):
        log_entries = self._filter_valid_entries(self.webu.eth.getFilterLogs(self.filter_id))
        return self._format_log_entries(log_entries)
