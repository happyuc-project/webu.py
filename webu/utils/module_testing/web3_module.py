...
class WebuModuleTest:
    def test_webu_clientVersion(self, webu):
        client_version = webu.version.node
        self._check_webu_clientVersion(client_version)
    ...
    def test_soliditySha3(self, webu, types, values, expected):
    ...
    def test_soliditySha3_same_number_of_types_and_values(self, webu, types, values):
        with pytest.raises(ValueError):
            webu.soliditySha3(types, values)

    def test_is_connected(self, webu):
        assert webu.isConnected()
