...
The ``webu.eth`` object exposes the following properties and methods to
...
you can find the latest block number in these two ways:
    ...
    .. code-block:: python
        ...
        >>> next_block = webu.utils.datastructures.AttributeDict(block, number=4022282)
        >>> next_block.number
        4022282
...
The following methods are available on the ``webu.eth`` namespace.
...
.. py:method:: Eth.getBalance(account, block_identifier=eth.defaultBlock)
    ...
    * Delegates to ``eth_getBalance`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getBalance('0xd3cda913deb6f67967b99d67acdfa1712c293601')
...
.. py:method:: Eth.getStorageAt(account, position, block_identifier=eth.defaultBlock)
    ...
    * Delegates to ``eth_getStorageAt`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getStorageAt('0x6c8f2a135f6ed072de4503bd7c4999a1a17f824b', 0)
...
.. py:method:: Eth.getCode(account, block_identifier=eth.defaultBlock)
    ...
    * Delegates to ``eth_getCode`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getCode('0x6c8f2a135f6ed072de4503bd7c4999a1a17f824b')
        '0x6060604052361561027c5760e060020a60003504630199.....'
        # For a private key address.
        >>> webu.eth.getCode('0xd3cda913deb6f67967b99d67acdfa1712c293601')
        '0x'
...
.. py:method:: Eth.getBlockTransactionCount(block_identifier)
    ...
    * Delegates to ``eth_getBlockTransactionCountByNumber`` or
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getBlockTransactionCount(46147)
        1
        >>> webu.eth.getBlockTransactionCount('0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd')  # block 46147
        1
...
.. py:method:: Eth.getTransaction(transaction_hash)
    ...
    * Delegates to ``eth_getTransactionByHAsh`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getTransaction('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')
        AttributeDict({
...
.. py:method:: Eth.getTransactionFromBlock(block_identifier, transaction_index)
    ...
    * Delegates to ``eth_getTransactionByBlockNumberAndIndex`` or
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getTransactionFromBlock(46147, 0)
        AttributeDict({
            'blockHash': '0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd',
            'blockNumber': 46147,
            'from': '0xa1e4380a3b1f749673e270229993ee55f35663b4',
        ...
        >>> webu.eth.getTransactionFromBlock('0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd', 0)
        AttributeDict({
            'blockHash': '0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd',
            'blockNumber': 46147,
            'from': '0xa1e4380a3b1f749673e270229993ee55f35663b4',
...
.. py:method:: Eth.waitForTransactionReceipt(transaction_hash, timeout=120)
    ...
    .. code-block:: python
        ...
        >>> webu.eth.waitForTransactionReceipt('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')
...
.. py:method:: Eth.getTransactionReceipt(transaction_hash)
    ...
    * Delegates to ``eth_getTransactionReceipt`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getTransactionReceipt('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')  # not yet mined
        None
        # wait for it to be mined....
        >>> webu.eth.getTransactionReceipt('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')
        AttributeDict({
            'blockHash': '0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd',
            'blockNumber': 46147,
            'contractAddress': None,
...
.. py:method:: Eth.getTransactionCount(account, block_identifier=webu.eth.defaultBlock)
    ...
    * Delegates to ``eth_getTransactionCount`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.getTransactionCount('0xd3cda913deb6f67967b99d67acdfa1712c293601')
        340
...
.. py:method:: Eth.sendTransaction(transaction)
    ...
    * ``from``: ``bytes or text``, hex address or ENS name - (optional, default:
      ``webu.eth.defaultAccount``) The address the transaction is send from.
    ...
    * ``nonce``: ``integer`` - (optional) Integer of a nonce. This allows to
    ...
    :meth:`~webu.eth.Eth.estimateGas()` function with an additional buffer of ``100000``
    gas up to the ``gasLimit`` of the latest block.  In the event that the
    value returned by :meth:`~webu.eth.Eth.estimateGas()` method is greater than the
    ``gasLimit`` a ``ValueError`` will be raised.


    .. code-block:: python

        >>> webu.eth.sendTransaction({'to': '0xd3cda913deb6f67967b99d67acdfa1712c293601', 'from': webu.eth.coinbase, 'value': 12345})
...
.. py:method:: Eth.sendRawTransaction(raw_transaction)
    ...
    * Delegates to ``eth_sendRawTransaction`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> raw_tx_hex = webu.toHex(raw_tx)
        >>> webu.eth.sendRawTransaction(raw_tx_hex)
        '0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331'
...
.. py:method:: Eth.replaceTransaction(transaction_hash, new_transaction)
    ...
    * Delegates to ``eth_sendTransaction`` RPC Method
    ...
    as required by :meth:`~webu.eth.Eth.sendTransaction`. It will be used to entirely
    ...
    * The ``gasPrice`` as calculated by the current gas price strategy(See :ref:`Gas_Price`).
    ...
    .. code-block:: python
        ...
        >>> tx = webu.eth.sendTransaction({
                'to': '0xd3cda913deb6f67967b99d67acdfa1712c293601',
                'from': webu.eth.coinbase,
                'value': 1000
            })
        '0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331'
        >>> webu.eth.replaceTransaction('0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331', {
                'to': '0xd3cda913deb6f67967b99d67acdfa1712c293601',
                'from': webu.eth.coinbase,
                'value': 2000
            })
...
.. py:method:: Eth.modifyTransaction(transaction_hash, **transaction_params)
    ...
    * Delegates to ``eth_sendTransaction`` RPC Method
    ...
    parameters as required by :meth:`~webu.eth.Eth.sendTransaction`. The parameter values
    will override the pending transaction's values to create the replacement transaction
    to send.

    The same validation and defaulting rules of :meth:`~webu.eth.Eth.replaceTransaction` apply.
    ...
    .. code-block:: python
        ...
        '0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331'
        >>> webu.eth.modifyTransaction('0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331', value=2000)
...
.. py:method:: Eth.call(transaction, block_identifier=webu.eth.defaultBlock)
    ...
    * Delegates to ``eth_call`` RPC Method
    ...
    :meth:`~webu.eth.Eth.sendTransaction()` method.
    ...
    In most cases it is better to make contract function call through the :py:class:`webu.contract.Contract` interface.
...
.. py:method:: Eth.estimateGas(transaction)
    ...
    * Delegates to ``eth_estimateGas`` RPC Method
    ...
    .. code-block:: python
        ...
        >>> webu.eth.estimateGas({'to': '0xd3cda913deb6f67967b99d67acdfa1712c293601', 'from': webu.eth.coinbase, 'value': 12345})
        21000
...
.. py:method:: Eth.generateGasPrice(transaction_params=None)
    ...
    .. note::
        For information about how gas price can be customized in webu see
        :ref:`Gas_Price`.
...
.. py:method:: Eth.setGasPriceStrategy(gas_price_strategy)
    ...
    ``(webu, transaction_params)`` and return a gas price denominated in wei.

Filters
-------

The following methods are available on the ``webu.eth`` object for interacting
...
.. py:method:: Eth.filter(filter_params)
    ...
    * If ``filter_params`` is a dictionary then a new filter is registered
    ...
    This method returns a ``webu.utils.filters.Filter`` object which can then
    ...
    * ``topics``: list of 32 byte ``strings`` or ``null`` - (optional) Array of
    ...
    .. code-block:: python
        ...
        >>> webu.eth.filter('latest')
        <BlockFilter at 0x10b72dc28>
        >>> webu.eth.filter('pending')
        <TransactionFilter at 0x10b780340>
        >>> webu.eth.filter({'fromBlock': 1000000, 'toBlock': 1000100, 'address': '0x6c8f2a135f6ed072de4503bd7c4999a1a17f824b'})
...
.. py:method:: Eth.getFilterChanges(self, filter_id)
    ...
    * Delegates to ``eth_getFilterChanges`` RPC Method.
    ...
    .. code-block:: python
        ...
        >>> filt = webu.eth.filter()
        >>> webu.eth.getFilterChanges(filt.filter_id)
        [
            {
...
.. py:method:: Eth.getFilterLogs(self, filter_id)
    ...
    * Delegates to ``eth_getFilterLogs`` RPC Method.
    ...
    .. code-block:: python
        ...
        >>> filt = webu.eth.filter()
        >>> webu.eth.getFilterLogs(filt.filter_id)
        [
            {
                'address': '0xdc3a9db694bcdd55ebae4a89b22ac6d12b3f0c24',
                'blockHash': '0xb72256286ca528e09022ffd408856a73ef90e7216ac560187c6e43b4c4efd2f0',
...
.. py:method:: Eth.uninstallFilter(self, filter_id)
    ...
    * Delegates to ``eth_uninstallFilter`` RPC Method.
    ...
    .. code-block:: python
        ...
        >>> filt = webu.eth.filter()
        >>> webu.eth.uninstallFilter(filt.filter_id)
        True
        >>> webu.eth.uninstallFilter(filt.filter_id)
